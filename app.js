var myArgs = process.argv.slice(2); //that the first arg is usually the path to nodejs, and the second arg is the location of the script you're executing.(StackOverflow)
var fs = require("fs");
...
switch (myArgs[0]) {
  ...
  default:
    ...
    console.log(
      chalk.red("List of available commands: add, remove, list, read")
    );
    break;
}
